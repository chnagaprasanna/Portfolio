        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/chnagaprasanna/volume-control-using-hand-detection"
              demoLink="#"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/chnagaprasanna/Brightness-Control-Through-Hand-Gestures"
              demoLink="#"              
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/chnagaprasanna/FinalYearProject"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              ghLink="https://github.com/chnagaprasanna/KIET-RCTS-TASK1"
